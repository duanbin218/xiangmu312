...
import ctypes
import math
import config  # Centralize kmNet/map settings to a single source.
...
def 监控延时(毫秒: int):
    ...
    while True:
        ...
        # Simplify math without changing behavior.
