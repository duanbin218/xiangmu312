...
# region 绘制网格
def _make_gird_vis(grid: np.ndarray, cell_size: int, line_color=(200, 200, 200)):
    """
    生成放大后的网格底图，并统一绘制网格线。
    """
...
def visualize_grid_and_path(
    ...
    vis, h, w = _make_gird_vis(grid_view, cell_size)
...
# region =====================  可视化放大显示地图上的出发点/中心点/怪物点/网格风险值/每个点的范围  =====================
def visualize_move(
    grid: np.ndarray,
    a_pos: Tuple[int, int],
